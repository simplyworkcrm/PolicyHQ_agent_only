...
export const CallReportWavv: React.FC = () => {
  ...
  return (
    <div className="call-report-dashboard animate-in fade-in duration-300 -mx-6 -mt-4 -mb-12">
      <div style={{ background: 'linear-gradient(160deg, #061018 0%, #03080f 100%)', minHeight: '100%' }} className="call-report-surface px-8 pt-7 pb-16">
        ...
        {/* ── Main Dark Card ──────────────────────────────────────────────── */}
        <div className="call-report-card rounded-3xl overflow-hidden" style={{ background: '#060d14', border: '1px solid rgba(255,255,255,0.06)' }}>
